...
- Not all code is created equal. 10k offsets in a `static` [phf](https://crates.io/crates/phf) HashMap don't show up anywhere in cargo-llvm-lines and barely affect compile times compared to a 10k line match statement which takes _minutes_ to compile.
