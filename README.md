...
[![License (AGPLv3)](https://img.shields.io/github/license/martin-t/cvars)](https://github.com/martin-t/cvars/blob/master/LICENSE)
...
- **Minimize the amount of generated code.** Proc macros are often not slow because of the macro's code itself but because they generate a lot of code which is turned into a lot of LLVM IR which takes the backend a lot of time to chew through. For example the case mentioned above spends only 70 ms in macro code, the rest of the 6 s is codegen. [Extracting repeated code to functions](19c2be9c6572a60e582b9be851d16f56509bdcbf) gives a [1.5-3.0x speedup](edd5d1b109b39f3b64bdb41d36d1df5f25daae15) because a function call takes fewer lines of LLVM IR.
